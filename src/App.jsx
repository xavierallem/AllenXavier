...
import { GithubIcon, Mail, BookOpen, Code2 } from 'lucide-react';
            ...
            <div className="relative">
              ...
              <div className="space-y-12 relative">
                {experiences.map((exp, index) => (
                  <div key={exp.title + exp.company} className="relative pl-20 hover:scale-105 transition-transform">
                    <div 
                    ...
                    <div
                      className={`bg-gray-800 p-6 rounded-lg transform transition-all duration-500 ${
                    ...
                    >
                      <div className="flex justify-between items-start mb-4">
                        <div>
                          <h3 className="text-xl font-bold group-hover:text-blue-400 transition-colors">{exp.title}</h3>
